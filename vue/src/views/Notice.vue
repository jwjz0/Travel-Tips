  ...
  <div>
    <div class="card" style="margin-bottom: 5px">
      <el-input clearable @clear="load" style="width: 240px; margin-right:5px " v-model="data.title"
                :prefix-icon="Search" placeholder="请输入公告标题查询"></el-input>
      <el-input clearable @clear="load" style="width: 240px; margin-right:5px " v-model="data.content"
                :prefix-icon="Search" placeholder="请输入公告内容查询"></el-input>
